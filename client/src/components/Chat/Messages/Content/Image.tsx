...
const Image = ({
  ...
  return (
    <div ref={containerRef}>
      <div
        className={cn(
          'relative mt-6 mb-6 flex h-auto w-full zzz-max-w-lg items-center justify-center overflow-hidden rounded-lg border border-border-light text-text-secondary-alt shadow-md',
          className,
        )}
      >
        <button
