...
export const interfaceSchema = z
  .object({
    ...
    stripeSubscriptionsEnabled: z.boolean().optional(),
    stripeMetersEnabled: z.boolean().optional(),
    searchModelsEnabled: z.boolean().optional(),
    settingsDataControls: z.boolean().optional(),
    settingsPersonalization: z.boolean().optional(),
    settingsCommands: z.boolean().optional(),
    settingsChat: z.boolean().optional(),
