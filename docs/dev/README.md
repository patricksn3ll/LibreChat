...
- This requires you use a MongoDB Atlas connection string for the `mongodb+srv://info_db_user:DJURZlEOSVVzqJws@cluster0.bm1zura.mongodb.net/?appName=Cluster0` env var
